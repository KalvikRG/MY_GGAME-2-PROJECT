...
function setup(){
    ...
    world = engine.world;
     ...
     ground = new Ground(600,690,1300,10)
     support1 = new Ground(802,500,410,30)
    ...
    //set2
     ...
     block20 = new Block(720.5,453,80,20)
     ...
     //set3
     block26 = new Block(837,274,80,20)
     ...
     block34 = new Block(1110.5,25,80,20)
